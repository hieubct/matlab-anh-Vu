...
% - Tính toán sơ bộ.
% - Xác định độ dày màng dầu: Tư tưởng ở đây là xác định theo phương pháp hình học.


% Để tính phương trình cân bằng dòng chảy:
% - Cho trước áp suất hốc lõm Pr
% - Tính toán áp suất thủy tĩnh Ps, phương trình Eq2
% - So sánh phương trình cân bằng dòng chảy. Nếu không cân bằng quay lại bước 1.
...
m=100;
n=50;
phiTC = 2*pi/3; % goc dau cua pad
phi12 = 4*pi/3;% goc sau cua pad
deltaphi1=(phi12-phiTC)/m;
deltalanda=2/n;
L=150e-3;
RZ=115e-3;% ban kinh pad
RP=100.21e-3;% ban kinh lap rap
CP=0.21e-3;% khe ho lap r�p
anpha=0.19*pi/180;% g�c xoay cua pad
capa=RP*anpha/CP;
lrz=2*RZ/L;
