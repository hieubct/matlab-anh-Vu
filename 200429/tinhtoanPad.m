...
function output = tinh_do_day_mang_dau(input)
    %myFun - Description
    %
...
function output = tinh_ap_suat_dong(input)
    %myFun - Description
    %
    % Syntax: output = myFun(input)
    %
...
function output = tinh_ap_suat_tinh(input)
    %myFun - Description
    %
    % Syntax: output = myFun(input)
    %
...
function output = tinh_luu_luong(input)
    %myFun - Description
    %
    % Syntax: output = myFun(input)
    %
...
function output = tinh_mo_men(input)
    %myFun - Description
    %
    % Syntax: output = myFun(input)
    %
